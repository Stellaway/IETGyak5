  ...
  public boolean fireTorpedo(FiringMode firingMode) {
    ...
    switch (firingMode) {
      ...
      case ALL:
        ...
        boolean primaryFired = primaryTorpedoStore.isEmpty() ? false : primaryTorpedoStore.fire(1);
        boolean secondaryFired = secondaryTorpedoStore.isEmpty() ? false : secondaryTorpedoStore.fire(1);
